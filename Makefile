...
bin/test: build/test/main.o build/test/test.o build/src/circle.o  build/src/triangle.o build/src/intersection.o
	gcc $(FLAGS) build/test/main.o build/test/test.o build/src/circle.o build/src/triangle.o build/src/intersection.o -o bin/test -lm
